...
export default function ChatPage() {
  ...
  return (
    <div className="bg-background w-full h-screen overflow-hidden selection:bg-primary/30">
      ...
      <main className={`flex flex-col mt-16 h-[calc(100vh-4rem)] ${isGuest ? "max-w-4xl mx-auto" : "md:ml-64"} bg-surface-dim relative`}>
          ...
          {loadingHistory ? (
            ...
            <div className="h-full flex flex-col items-center justify-center text-center space-y-8 pb-8">
              <div className="space-y-3">
                ...
                <p className="text-sm text-on-surface-variant max-w-sm mx-auto">Ask anything from the knowledge base or try one of these suggestions:</p>
              </div>
